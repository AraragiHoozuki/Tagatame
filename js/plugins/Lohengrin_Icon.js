...
var iconlist =
["adfdown","adfup","atsdown","atsup","attack","battle_notice_status_07","BattleUI_TargetMarker","blind","bronze","common","dead","default","defdown","defup","down","empty","evil_blade","evilkey","exp","fascinated","golden","gold","hammer","high_potion_blue","immune","IT_EQ_ANAS_GANTLET","IT_EV_DARK_POT","IT_EV_FIRE_POT","IT_EV_RAINBOW_POT","IT_EV_WATER_POT","IT_EV_WIND_POT","it_ingot_bronze","it_ingot_golden","it_ingot_silver","IT_KEY_QUEST_APPLE","IT_KEY_QUEST_GOLD","IT_KEY_QUEST_ORE","IT_US_EXTRA_POTION","IT_US_FATE_SANDWICH","IT_US_PARALYSIS","IT_US_REVIVAL_POTION","legendary","lolipop_red","mace","noattack","noheal","null","passive","七斗术师","双刀术师","金职证明","银职证明","七斗术","双刀术","圣剑技","圣骑士","武芸技","神圣术","锻造师","主教","剑技","剑豪","战士","战技","拳圣","拳套","拳技","武圣","盗技","盗贼","舞者","舞踏","薙刀","锻技","poison","potion_blue","potion_green","potion_purple","potion_rainbow","pot_yellow","regeneration","remove","s_barb_act","s_barb_burning_blood","s_barb_critical_slash","s_barb_dire_bond","s_barb_pas","s_barb_rage","scythe","silver","sleep","s_md_elemental_explosion","s_md_fire_strike","s_md_snow_strike","spddown","spdup","s_pray_act","s_pray_pas","st_down","strdown","strup","stun","st_up","sword","thanatos","twinblade_red","up","we_big_sword"];
