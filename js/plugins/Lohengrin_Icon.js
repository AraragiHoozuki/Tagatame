...
["am_blue_magarmor","attack","battle_notice_status_07","bronze","dead","default","empty","eq_mythrill_brace","eq_pink_heart","evil_blade","evilkey","fascinated","golden","gold","hammer","high_potion_blue","immune","it_aoisen","it_branch","it_cons_exp","it_cons_revive","it_cons_skillscroll_br","it_cons_skillscroll_gl","it_cons_skillscroll_sl","IT_EQ_ANAS_GANTLET","IT_EV_DARK_POT","IT_EV_FIRE_POT","IT_EV_RAINBOW_POT","IT_EV_WATER_POT","IT_EV_WIND_POT","it_ingot_bronze","it_ingot_golden","it_ingot_legendary","it_ingot_silver","IT_KEY_QUEST_APPLE","IT_KEY_QUEST_GOLD","IT_KEY_QUEST_ORE","it_pi_aoi_fist","it_pi_bullet","it_pi_mythrill_brace","it_pi_zin","it_thunderessence","IT_US_EXTRA_POTION","IT_US_FATE_SANDWICH","IT_US_PARALYSIS","it_zin","legendary","lolipop_red","mace","noattack","null","passive","七斗术师","双刀术师","金职证明","银职证明","七斗术","双刀术","圣剑技","圣骑士","武芸技","神圣术","锻造师","主教","剑技","剑豪","战士","战技","拳圣","拳套","拳技","武圣","盗技","盗贼","舞者","舞踏","薙刀","锻技","portrait_frame","potion_blue","potion_green","potion_purple","potion_rainbow","pot_yellow","regeneration","remove","s_barb_act","s_barb_burning_blood","s_barb_critical_slash","s_barb_dire_bond","s_barb_pas","s_barb_rage","scythe","silver","sk_craft","sk_eruk_act","sk_eruk_pas","sk_hwiz_act","sk_hwiz_pas","sk_katana_act","sk_katana_pas","sk_mag_act","sk_onmi_act","sk_onmi_pas","sk_sni_act","sk_sni_pas","sleep","s_md_elemental_explosion","s_md_fire_strike","s_md_snow_strike","s_pray_act","s_pray_pas","st_blind","st_down","st_noheal","st_para","st_poison","st_stun","st_up","sword","thanatos","twinblade_red","up","we_big_sword","wp_aoi_fist","wp_bullet","wp_jewelry_wand","wp_masket","wp_whitelily","wp_woodsword"]
